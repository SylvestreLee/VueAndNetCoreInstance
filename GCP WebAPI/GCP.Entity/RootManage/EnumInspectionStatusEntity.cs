...
{
    [JsonObject(MemberSerialization.OptIn), Table(DisableSyncStructure = true, Name = "enum_inspection_status")]
    public partial class EnumInspectionStatusEntity : BaseEntity
    {
